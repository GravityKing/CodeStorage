...
public class OculusHaptics : MonoBehaviour
{
    ...
    public void Vibrate(VibrationForce vibrationForce, OVRInput.Controller controller)
    {
    ...
    /// <summary>
    /// force : 강도, time : 진동시간, controller : 손의 위치 OVRInput.Controller.LTouch, OVRInput.Controller.RTouch
    /// </summary>
    /// <param name="force"></param>
    /// <param name="time"></param>
    /// <param name="controller"></param>
    public void VibrateTime(VibrationForce force, float time, OVRInput.Controller controller)
    {
        StartCoroutine(IEVibrateTime(force, time, controller));
    }
    bool forcedHaptic;
    IEnumerator IEVibrateTime(VibrationForce force, float time, OVRInput.Controller controller)
    {
        forcedHaptic = true;
        var channel = OVRHaptics.RightChannel;
        if (controller == OVRInput.Controller.LTouch)
